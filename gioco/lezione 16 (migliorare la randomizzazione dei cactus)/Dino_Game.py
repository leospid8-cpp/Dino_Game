...
class dino_game: 
    ...
    def aggiorna_cactus(self):
        ...
        # riposiziona i cactus usciti dallo schermo mantenendo distanza minima/massima
        for c in self.cactus:  # ripete il ciclo per ogni cactus
            if c.rettangolo.right < 0: #controlla se il cactus e fuori dallo schermo a sinistra
                cactus_piu_avanti = self.schermata.get_width() #decide di quanto spostare il cactus
                gap = random.randint(250, 500)  # separatore
                c.rettangolo.left = cactus_piu_avanti + gap #aggiunge il il gap alla distanza normale
