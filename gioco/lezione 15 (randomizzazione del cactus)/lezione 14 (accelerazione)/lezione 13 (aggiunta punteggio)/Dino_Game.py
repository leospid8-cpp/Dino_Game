...
class dino_game: 
    ...
    def esegui_gioco(self): 
        while(True): 
            ...
            self.aggiorna_cactus() #aggiorna la posizione dei cactus
    ...
    def controlla_eventi(self): 
        ...
        if self.secondi >= self.aggiunta_cactus: #aggiunge un nuovo cactus ogni 200 secondi
    ...
    def aggiorna_schermo(self): 
        ...
        self.disegna_cactus() #disegna i cactus sulla schermata
    ...
    def aggiorna_cactus(self): #aggiorna la posizione dei cactus e gestisce la loro ricomparsa
        for c in self.cactus:
            c.aggiorna(self.secondi)

    def disegna_cactus(self): #disegna i cactus sulla schermata
        for c in self.cactus: 
            c.disegna()
